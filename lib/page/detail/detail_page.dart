...
import 'package:quafulplayer/constant/constant.dart';
import 'package:quafulplayer/data/comments_entity.dart';
...
import 'package:quafulplayer/http/http_request.dart';
import 'package:quafulplayer/page/detail/play_select_widget.dart';
import 'package:quafulplayer/page/detail/score_start.dart';
import 'package:quafulplayer/util/palette_generator.dart';
import 'package:quafulplayer/widget/animal_photo.dart';
import 'package:quafulplayer/widget/bottom_drag_widget.dart';
import 'package:quafulplayer/widget/rating_bar.dart';
import 'detail_title_widget.dart';
import 'long_comment_widget.dart';
import 'movie_long_comments_entity.dart';
...
class DetailPage extends StatefulWidget {
  ...
  DetailPage({Key key, this.searchResponseData, this.movieDetailBean}) : super(key: key);
...
class _DetailPageState extends State<DetailPage> {
  ...
  void initState() {
    super.initState();
    subjectId = widget.searchResponseData.dBID;
    requestAPI();
  }
...
//    _movieDetailBean = widget.movieDetailBean;
  ...
  SliverToBoxAdapter sliverPlaylist() {
    return SliverToBoxAdapter(
      child: SizedBox(height: 40,child: PlaySelectWidget(
        searchResponseData: widget.searchResponseData,
      ),),
    );
  }
}
