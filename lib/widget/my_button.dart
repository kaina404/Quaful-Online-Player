...
class MyCupertinoButton extends StatefulWidget {
  ...
  const MyCupertinoButton({
    ...
    this.enable,
    this.fontSize,
    this.backgroundButtonPadding = const EdgeInsets.symmetric(
      vertical: 10.0,
      horizontal: 15.0,
    ),
    this.minSize = 44.0,
  ...
  final EdgeInsets backgroundButtonPadding;
  ...
  /// [MyCupertinoButton.filled] constructor is used.
  final Color color;
  ...
  bool get enabled => enable != null ? enable : (onPressed != null);
...
class _MyCupertinoButtonState extends State<MyCupertinoButton>
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle textStyle = widget.fontSize == null
        ...
        : CupertinoTheme.of(context)
            .textTheme
            .textStyle
            .copyWith(color: foregroundColor, fontSize: widget.fontSize);
              ...
              child: Padding(
                padding: widget.padding ??
                    (backgroundColor != null
                        ? widget.backgroundButtonPadding
                        : _kButtonPadding),
                child: Center(
                  widthFactor: 1.0,
                  heightFactor: 1.0,
